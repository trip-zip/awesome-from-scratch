...
function calendar_widget.create()
  ...
  -- Navigation actions
  prev_button:add_button(awful.button({}, 1, function()
  ...
  next_button:add_button(awful.button({}, 1, function()
    displayed_date.month = displayed_date.month + 1
  ...
  today_button:add_button(awful.button({}, 1, function()
  ...
  for _, btn in ipairs({ prev_button, next_button, today_button }) do
    btn:connect_signal("mouse::enter", function()
      btn.fg = beautiful.primary_color_hover
    end)
    btn:connect_signal("mouse::leave", function()
      btn.fg = btn == today_button and beautiful.primary_color or beautiful.fg_normal
    end)
  end
