...
local client_helpers = {
  ...
  move_to_master = function(c)
    -- The first visible client on the screen is the master.
...
local client_keys = {
  ...
  {{ modkey, "Control" }, "space",  client_helpers.toggle_floating,         "toggle floating",           "client" },
  {{ modkey, "Control" }, "Return", client_helpers.move_to_master,          "move to master",            "client" },
  --modkey shift modifier
